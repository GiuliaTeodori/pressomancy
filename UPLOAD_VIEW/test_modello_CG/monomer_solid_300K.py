...
context_string = "monomer_solid_300K"
...
part_per_filament = 1 #ogni filamento è composto da due quadruplex
...
context_string = "monomer_solid_300K"  # puoi metterci un nome univoco per il tuo esperimento
dir_path = f"/home/stekajack/DATA/checkpoints/{context_string}"
...
def salva_osservabili(timestep, mode='new'):
    ...
    file_path = f"/home/stekajack/DATA/{context_string}.txt"
...
data_pathh=f"/home/stekajack/DATA/{context_string}.lammpstrj"
...
def fuoir(sim_inst, step, box_dim, filename=data_pathh, mode="load"):
    ...
    with open(filename, "a") as f:  # Append sempre dopo il primo
        ...
        for p in all_particles:
            x, y, z = p.pos
            radius = 0.25 if p.type in (100, 101, 102, 104, 105) else 0.5
