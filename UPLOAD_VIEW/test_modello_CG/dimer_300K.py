...
bond_quad = BondWrapper(espressomd.interactions.FeneBond(k=300., r_0=2., d_r_max=2*1.5))
...
data_pathh=f"/home/stekajack/DATA/traiettorie/{context_string}.lammpstrj"
